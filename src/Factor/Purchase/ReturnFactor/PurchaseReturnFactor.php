...
namespace Src\Factor\Purchase\ReturnFactor;

use Src\Factor\Factor;
use Src\Factor\FactorStrategy;

class PurchaseReturnFactor extends Factor implements FactorStrategy
{
